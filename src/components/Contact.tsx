...
export function Contact() {
    ...
    return (
        <div className="contact-container">
            ...
            <div style={{marginBottom: '30px', color: "white"}}>.</div>
            ...
            <div className="contact-links">
                ...
                <a id="a" href="mailto:devkosi1203@gmail.com">
                <div style={{marginRight: '10px'}}>
                    devkosi1203@gmail.com
                </div></a>
                ...
                <a id="a" href="linkedin.com/in/kojo-sika-842163361"><div>
                    LinkedIn
                </div></a>
            </div>
            
            <div className="copy-right">
                Copyright &copy; 2025 Dev KoSi. All Right Reserved
            </div>
        </div>
    )
}